...
import com.artdealergame.ArtDealerGame68;
import com.artdealergame.ArtDealerGame68.BooleanStringPair;
...
public class Grade68Window {
    ...
    public Grade68Window() {
        ...
        chooseLevelButton.addActionListener(e -> {
            G68Frame.dispose(); // Close this window
        ...
        G68Frame.add(instructionPanel, BorderLayout.NORTH); // Add instruction panel at the top
    ...
    private void checkSelectedCards() {
        if (selectedCount == 4) {
            ...
            if (response == JOptionPane.YES_OPTION) {
                ...
                // Create an instance of ArtDealerGame68 and check matching cards
                // ArtDealerGame68 game = new ArtDealerGame68();
